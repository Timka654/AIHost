...
/// <summary>
/// Test method implementations - partial class
/// </summary>
public static partial class TestRunner
{
    public static void TestComputeShader(ICompute.IComputeDevice provider)
    {
...
";
    ...
    public static void TestGGUFLoader(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestDequantization(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestMatMul(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestTensorOps(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestRopeAndAttention(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestTokenizer(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestMultiHeadAttention(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestFFN(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestTransformer(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestInference(ICompute.IComputeDevice provider)
    {
    ...
    public static void TestInferenceEngine(ICompute.IComputeDevice provider, string? modelPath = null)
    {
    ...
    public static void TestInferenceDemo(ICompute.IComputeDevice provider)
    {
